...
/** Type definition for the keys in the dictionary from English to Japanese. */
export type E2JKeys = keyof typeof e2jJson;

/** Type definition for the dictionary from English to Japanese. */
...
/** Type definition for the dictionary from Hiragana to English. */
